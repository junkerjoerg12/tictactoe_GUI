...
public class Tictactoe {
	...
	static boolean mitterandang= false;		//Spieler wählte die Mitte der äußeren Zeilen/Spalten/ einen beliebigen mitterand wenne anfängt
	...
	static Scanner tastatur=new Scanner(System.in);
			...
			public static void main(String[] args) {
				...
				a=(int)(Math.random()*2);					//Wenn gleich null Computer als erstes am Zug, wenn 1 Spieler als erstes am Zug
